\chapter{Upgradeability of Smart Contracts on Ethereum} 
\label{ch:upgrade}
...
\subsection{Dealing with two New Versions of a Dapp}
...
\begin{figure}[t!]
 \includegraphics[keepaspectratio,height=20cm, width=15cm]{figures/proxy-finder-module.png}
